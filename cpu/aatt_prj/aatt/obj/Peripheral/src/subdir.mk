...
Peripheral/src/%.o: ../Peripheral/src/%.c
	@	@	riscv-none-embed-gcc -march=rv32ecxw -mabi=ilp32e -msmall-data-limit=0 -msave-restore -Os -fmessage-length=0 -fsigned-char -ffunction-sections -fdata-sections -fno-common -Wunused -Wuninitialized  -g -I"D:\proj\velograph\aatt\cpu\aatt_prj\aatt\Debug" -I"D:\proj\velograph\aatt\cpu\aatt_prj\aatt\Core" -I"D:\proj\velograph\aatt\cpu\aatt_prj\aatt\User" -I"D:\proj\velograph\aatt\cpu\aatt_prj\aatt\Peripheral\inc" -std=gnu99 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@)" -c -o "$@" "$<"
	@	@
